...
static const _AgentExternalState_type_support_symbol_names_t _AgentExternalState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, macspos_msgs, msg, AgentExternalState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, macspos_msgs, msg, AgentExternalState)),
  }
};
...
{
  return &::macspos_msgs::msg::rosidl_typesupport_cpp::AgentExternalState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, macspos_msgs, msg, AgentExternalState)() {
  return get_message_type_support_handle<macspos_msgs::msg::AgentExternalState>();
}
