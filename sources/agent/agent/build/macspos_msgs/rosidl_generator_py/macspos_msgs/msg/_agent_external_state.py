...
class Metaclass_AgentExternalState(type):
    """Metaclass of message 'AgentExternalState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'macspos_msgs.msg.AgentExternalState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__agent_external_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__agent_external_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__agent_external_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__agent_external_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__agent_external_state
...
class AgentExternalState(metaclass=Metaclass_AgentExternalState):
    """Message class 'AgentExternalState'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.ongoing = kwargs.get('ongoing', int())
    ...
    def ongoing(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ongoing' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'ongoing' field must be an integer in [-32768, 32767]"
        self._ongoing = value
